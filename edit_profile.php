		...
		<div class="col-sm-8">
			<form action="" method="post" enctype="multipart/form-data">
				<table class="table table-bordered table-hover">
					...
					<tr>
						<td style="font-weight: bold;">Relationship Ststus</td>
                  ...
                  <tr>
						...
						<td><input class="form-control" type="password" name="u_pass" id="mypass" required value="<?php echo $user_pass; ?>"><input type="checkbox" onclick="show_password()"><strong>Show Password</strong></td>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="recovery.php?id=<?php echo $user_id;?>" method="post" id="f">
												...
												<pre>Answer the above question we will ask the question if you forgot your <br>password</pre>
											</form>
