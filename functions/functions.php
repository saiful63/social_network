...
$con = mysqli_connect("localhost","root","","conn_network") or die("Connection was not established");
...
/* this is for viewing the message*/
      ...
      <div class='col-md-4'>
        ...
        <div class='col-md-6'>
              <div class='forme'>
                 <form action='' method='post'>
                   <textarea rows='4' cols='50' placeholder='whats in your mind?' class='form-control'  name='comment' ></textarea><br>
		...
		if(isset($_POST['reply'])){
			...
			if($comment==""){
				...
				//$insert="inaert into comments (`com_id`, `post_id`, `user_id`, `comment`, `comment_author`, `date`) values( NULL,'$post_id','$user_id','$comment','$user_com_name',NOW())";

				$insert="INSERT INTO `comments` (`com_id`, `post_id`, `user_id`, `comment`, `comment_author`, `date`) VALUES (NULL, '$post_id', '$user_id', '$comment', '$user_com_name', current_timestamp())";

				$run=mysqli_query($con,$insert);
              echo"<script>alert(' your comment is loading!')</script>";

              /* ata na dile ager abar cole asbe*/
              echo"<script>window.open('single.php?post_id=$post_id','_self')</script>";
...
/* This portion for home page where user can search post*/
...
/* This portion for member.php where user can search*/
...
<div class='row'>
  ...
  <div class='col-sm-6'>
     ...
     <div class='row' id='find_people'>
       <div class='col-sm-4'>
            <a href='user_profile?u_id=$user_id'>
