...
if(isset($_POST['sign_up'])){
 ...
 $insert="INSERT INTO `users` (`user_id`, `f_name`, `l_name`, `user_name`, `describe_user`, `Relationship`, `user_pass`, `user_email`, `user_country`, `user_gender`, `user_birthday`, `user_image`, `user_cover`, `user_reg_date`, `status`, `post`, `recovery_account`) VALUES (NULL, '$first_name', '$last_name', '$username', 'Hello me', '...', '$pass', '$email', '$country', '$gender', '$birthday', 'f1.jpg', 'p1.jpg', current_timestamp(), 'verified', 'No', 'Iwanta');";
